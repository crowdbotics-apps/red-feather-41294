"""
Django settings for red_feather_41294 project.
...
ROOT_URLCONF = 'red_feather_41294.urls'
...
WSGI_APPLICATION = 'red_feather_41294.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_feather_41294 API",
    "DESCRIPTION": "API documentation for red_feather_41294 App",
    "VERSION": "v1",
}
